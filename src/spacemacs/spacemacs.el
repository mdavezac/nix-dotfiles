...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '( direnv vterm )
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default nil)
   dotspacemacs-lines-numbers 'relative
...
before packages are loaded."
  ...
  (setq projectile-project-search-path '("~/personal/" "~/kagenova/"))
)
